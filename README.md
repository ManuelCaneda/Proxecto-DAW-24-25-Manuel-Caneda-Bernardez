...
As tecnoloxías que serán utilizadas para a realización desta web son: HTML5, CSS3, JavaScript, PHP (MVC) (non se descarta a utilización dalgunha librería de PHP ou JavaScript).
